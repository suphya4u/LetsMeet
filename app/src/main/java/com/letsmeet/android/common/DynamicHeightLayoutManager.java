 ...
 * the measure pass.
 */
public class DynamicHeightLayoutManager extends android.support.v7.widget.LinearLayoutManager {
  ...
  public DynamicHeightLayoutManager(Context context, float maxHeight) {
    super(context);
  ...
  private void measureChild(RecyclerView.Recycler recycler, int position, int widthSize,
    ...
    final int childHeightSpec = getChildMeasureSpec(heightSize, vPadding + vMargin + vDecoration,
        p.height, canScrollVertically());
