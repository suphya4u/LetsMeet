 ...
 * on 2015-07-25 at 03:39:50 UTC 
 * Modify at your own risk.
 */

package com.letsmeet.server.registration;
...
public class Registration extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class ListDevices extends RegistrationRequest<com.letsmeet.server.registration.model.CollectionResponseRegistrationRecord> {
    ...
    protected ListDevices(java.lang.Integer count) {
      super(Registration.this, "GET", REST_PATH, null, com.letsmeet.server.registration.model.CollectionResponseRegistrationRecord.class);
   ...
   *
   * @param content the {@link com.letsmeet.server.registration.model.RegistrationRequest}
   * @return the request
   */
  public Register register(com.letsmeet.server.registration.model.RegistrationRequest content) throws java.io.IOException {
    Register result = new Register(content);
    initialize(result);
    return result;
  }

  public class Register extends RegistrationRequest<com.letsmeet.server.registration.model.RegistrationResponse> {
     ...
     * @since 1.13
     */
    protected Register(com.letsmeet.server.registration.model.RegistrationRequest content) {
      super(Registration.this, "POST", REST_PATH, content, com.letsmeet.server.registration.model.RegistrationResponse.class);
    }
